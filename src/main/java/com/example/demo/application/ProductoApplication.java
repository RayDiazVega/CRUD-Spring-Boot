...
public class ProductoApplication {
	...
	public ProductoRest actualizar(ProductoRest producto, String codigo) {
		ProductoRest encontrado = productoMapper
				.DomToRest(productoService.actualizarPorId(productoMapper.RestToDom(producto), new Codigo(codigo)));
	...
	public String reporte() throws FileNotFoundException, JRException {
		return productoService.generateReport();
	}
}
